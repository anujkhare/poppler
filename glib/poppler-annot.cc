 ...
 * @rect: a #PopplerRectangle
 * @font_size: a #gdouble
 * @font_color: a #PopplerColor
 *
 * Creates a Free Text annotation with font size @font_size and font
 * color @font_color that will be located on @rect when added to a page.
 * See poppler_page_add_annot().
 * Annotation takes ownership of @font_color.
 *
                             ...
                             PopplerColor     *font_color)
{
  ...
  goo_tmp = create_appearance_string (font_size, font_color);
  ...
  poppler_ftext->font_size = font_size;
  poppler_ftext->font_color = font_color;
