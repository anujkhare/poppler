...
#define POPPLER_TYPE_ANNOT_APPEARANCE        (poppler_font_description_get_type ())
...
PopplerFontDescription       *poppler_font_description_copy                    (PopplerFontDescription *appr);
void                          poppler_font_description_free                    (PopplerFontDescription *appr);
